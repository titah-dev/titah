...
no number. The summariser's own prompt is bounded too, and a transcript larger
than the summariser's window is summarised in chunks rather than silently
truncated by the provider. Design:
